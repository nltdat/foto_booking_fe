    ...
    >
          ...
          <div className="relative h-[25.5rem] overflow-hidden rounded-[2rem] border border-[#e7d7c5] bg-[#efe5d5] shadow-[0_24px_70px_rgba(89,61,44,0.14)] sm:h-[29.5rem] lg:h-[32rem]">
            ...
            <div className="absolute inset-x-0 bottom-4 z-20 px-4 sm:px-8 lg:px-16">
              <div className="mx-auto grid max-w-[44rem] items-center gap-0 overflow-hidden rounded-[1.35rem] border border-white/80 bg-white shadow-[0_18px_45px_rgba(82,57,35,0.18)] md:grid-cols-[1fr_1fr_1fr_9rem]">
                ...
                <button className="flex items-center justify-center gap-3 bg-[#f47c20] px-5 py-3.5 text-[1rem] font-extrabold text-white transition hover:bg-[#dd6a12]">
      ...
      >
        <div className="mx-auto grid max-w-[75rem] items-center gap-0 px-4 lg:grid-cols-[1.08fr_0.88fr]">
          ...
          <div className="z-10 mt-[-3rem] flex flex-col lg:-ml-8 lg:mt-0">
            <h2 className="mb-5 text-[2rem] font-bold leading-[1.16] tracking-[-0.03em] text-[#f47c20] sm:text-[2.45rem]">
              Chụp Là Thích!
              <br />
              Thích Là Chụp!
            </h2>
        ...
        <div className="mt-8 grid items-start gap-6 xl:grid-cols-3">
          {photographers.map((photographer) => (
            <article
              ...
              className="overflow-hidden rounded-[2rem] border border-[#f0f0f0] bg-[#f8f9fa] shadow-sm transition-all hover:shadow-md"
            >
              ...
              <div className="relative h-[18rem] overflow-hidden sm:h-[18.5rem] lg:h-[19rem]">
                ...
                <button className="absolute left-3 top-1/2 z-10 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full bg-black/20 text-white backdrop-blur-md">
                  <ChevronLeft className="h-5 w-5" />
                </button>
                <button className="absolute right-3 top-1/2 z-10 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full bg-black/20 text-white backdrop-blur-md">
              ...
              <div className="min-h-[15rem] px-5 pb-5 pt-4">
                ...
                <div className="mt-4 rounded-2xl bg-white p-4 text-[0.9rem] leading-relaxed text-gray-600 shadow-sm border border-gray-50">
                  {photographer.bio}
                </div>

                {/* Footer nút bấm */}
                <div className="mt-5 flex items-center justify-between pt-2">
                  <button className="flex items-center gap-2 font-semibold text-[#f47c20]">
                    <Heart className="h-5 w-5" />
                    Yêu thích
                  </button>
                  <button className="flex items-center gap-2 font-bold text-[#f47c20]">
                    Xem & Đặt lịch
                    <ArrowRight className="h-5 w-5" />
                  </button>
                </div>
      ...
      <div className="sticky bottom-0 z-20 border-t border-[#ead8c6] bg-[rgba(255,248,241,0.96)] backdrop-blur">
        <div className="mx-auto flex w-full max-w-[75rem] flex-col gap-4 px-4 py-4 text-sm text-[#6b5846] sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
          <p>
            Chúng tôi sử dụng cookie để đảm bảo bạn có trải nghiệm duyệt web tốt
            nhất trên trang web của chúng tôi.
          </p>
          <button className="rounded-2xl bg-[#f47c20] px-5 py-2.5 font-extrabold text-white transition hover:bg-[#dd6a12]">
            Đã biết
          </button>
        </div>
      </div>
